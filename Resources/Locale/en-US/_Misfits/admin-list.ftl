...
misfits-admin-list-open-mentorhelp = Mentor Help
misfits-admin-list-open-adminhelp = Admin Help
misfits-admin-list-connected-players = Connected Players: {$count}
misfits-admin-list-afk-players = AFK: {$count}
misfits-admin-list-ghost-players = Ghosts: {$count}

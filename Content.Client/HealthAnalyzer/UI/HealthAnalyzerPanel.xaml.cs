...
{
    /// <summary>
    /// The actual health analyzer scan display - body doll, vitals, damage breakdown, triage controls.
    /// Extracted out of HealthAnalyzerWindow so it can be embedded into other UIs
    [GenerateTypedNameReferences]
    public sealed partial class HealthAnalyzerPanel : ScrollContainer
    {

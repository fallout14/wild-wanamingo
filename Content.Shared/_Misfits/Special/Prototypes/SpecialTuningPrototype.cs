...
public sealed partial class SpecialTuningPrototype : IPrototype
{
    ...
    /// <summary>Weapon scope delay multiplier at Perception 1 (5 remains neutral).</summary>
    [DataField("perceptionScopeDelayMultiplierLow")]
    public float PerceptionScopeDelayMultiplierLow = 3f;

    /// <summary>Weapon scope delay multiplier at Perception 10.</summary>
    [DataField("perceptionScopeDelayMultiplierHigh")]
    public float PerceptionScopeDelayMultiplierHigh = 0.1f;

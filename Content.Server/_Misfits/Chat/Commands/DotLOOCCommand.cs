...
[AnyCommand]
internal sealed class DotLOOCCommand : IConsoleCommand
{
    public string Command     => ".looc";
    public string Description => "Alias for 'looc'. Send Local Out Of Character chat messages.";
